...
import { Cards, CardsContainer, CardSubcontainer, CardSubcontainerDescription, CardSubcontainerTitle, Img, Skillcards  } from './styles.ts'
    ...
    return (
        <Skillcards>
            <CardsContainer>
                <Cards>
                    <Img>
                        <CardImg1 className='CardImgClassOdd'/>
                    </Img>
                    <CardSubcontainer>
                ...
                <Cards>
                    ...
                    <Img>
                        <CardImg2 className='CardImgClassEven'/>
                    </Img>
                </Cards>
                <Cards>
                <Img>
                    <CardImg3 className='CardImgClassOdd'/>
                </Img>
                    <CardSubcontainer>
                ...
                <Cards>
                    ...
                    <Img>
                        <CardImg4 className='CardImgClassEven'/>
                    </Img>
                </Cards>       
            </CardsContainer>
        </Skillcards>
